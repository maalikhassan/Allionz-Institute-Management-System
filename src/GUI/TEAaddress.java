...
public class TEAaddress extends javax.swing.JFrame {
    ...
    public void loadAddress() {
        try {
            ...
            if (jComboBox1.getSelectedItem() == null) {
                JOptionPane.showMessageDialog(this, "Please select a teacher NIC from the dropdown.", "Warning", JOptionPane.WARNING_MESSAGE);
                return;
            }

            // Get the selected NIC from jComboBox1
            String teacherNic = jComboBox1.getSelectedItem().toString();

            // Query to fetch address details and NIC
            String query = "SELECT ta.line1, ta.line2, t.nic "
                    + "FROM teacher_address ta "
                    + "JOIN teachers t ON ta.teachers_teacher_id = t.teacher_id "
    ...
    public void setSelectedTeacherId(String teacherId) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Teacher Address View");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            // Get the teacher's NIC from jComboBox1
            String teacherNic = jComboBox1.getSelectedItem().toString();
            ...
            if (teacherNic.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Please select a teacher NIC.", "Warning", JOptionPane.WARNING_MESSAGE);
                ...
                // Query to fetch teacher_id using NIC
                ResultSet teacherResult = MySQL.executeSearch("SELECT `teacher_id` FROM `teachers` WHERE `nic` = '" + teacherNic + "'");

                if (teacherResult.next()) {
                    int teacherId = teacherResult.getInt("teacher_id");

                    // Check if an address already exists for this teacher
                    ResultSet addressResult = MySQL.executeSearch("SELECT * FROM `teacher_address` WHERE `teachers_teacher_id` = " + teacherId);

                    if (addressResult.next()) {
                        JOptionPane.showMessageDialog(this, "An address already exists for this teacher.", "Warning", JOptionPane.WARNING_MESSAGE);
                    } else {
                        // Insert the address into the teacher_address table
                        MySQL.executeIUD("INSERT INTO `teacher_address` (`line1`, `line2`, `teachers_teacher_id`) VALUES ('"
                                + line1 + "', '" + line2 + "', " + teacherId + ")");
                    ...
                    JOptionPane.showMessageDialog(this, "Teacher not found. Please check the NIC.", "Error", JOptionPane.ERROR_MESSAGE);
                }
        ...
        try {
            ...
            if (teacherNic.isEmpty()) {
                ...
                if (teacherResult.next()) {
                    ...
                    if (addressResult.next()) {
                        // Update the address in the teacher_address table
                        String updateQuery = "UPDATE `teacher_address` "
                                + "SET `line1` = '" + line1 + "', `line2` = '" + line2 + "' "
                                + "WHERE `teachers_teacher_id` = " + teacherId;
                        ...
                        JOptionPane.showMessageDialog(this, "No existing address found for this teacher. Please register the address first.", "Warning", JOptionPane.WARNING_MESSAGE);
                    }
        ...
        try {
            ...
            if (teacherNic.isEmpty()) {
                ...
                if (teacherResult.next()) {
                    ...
                    // Check if an address exists for this teacher
                    ResultSet addressResult = MySQL.executeSearch("SELECT * FROM `teacher_address` WHERE `teachers_teacher_id` = " + teacherId);

                    if (addressResult.next()) {
                        // Delete the address from the teacher_address table
                        String deleteQuery = "DELETE FROM `teacher_address` WHERE `teachers_teacher_id` = " + teacherId;
                        ...
                        JOptionPane.showMessageDialog(this, "No address found for this teacher.", "Warning", JOptionPane.WARNING_MESSAGE);
                    }
