    ...
    public void loadStudents(String searchTerm) {
        try {
            ...
            ResultSet resultSet = MySQL.executeSearch("SELECT * FROM `students` "
                    ...
                    + "INNER JOIN `AL_batch` ON `students`.`AL_batch_batch_id` = `AL_batch`.`batch_id` WHERE `nic` LIKE '" + searchTerm + "%' OR `mobile` LIKE '" + searchTerm + "%'");
...
//                    + "INNER JOIN `gender` ON `teachers`.`gender_id` WHERE `mobile` LIKE '" + searchTerm + "%'");
    ...
    public void loadLogins(String searchTerm) {
        try {
            ...
            ResultSet resultSet = MySQL.executeSearch(
                    ...
                    + "INNER JOIN `usertypes` ON `users`.`user_type_id` = `usertypes`.`user_type_id` WHERE `email` LIKE '" + searchTerm + "%' OR `usertypes`.`user_type_name` LIKE '" + searchTerm + "%'"
            );
    ...
    private void loadActivityLog(String searchTerm) {
        try {

            ResultSet resultSet = MySQL.executeSearch("SELECT * FROM `system_logs` WHERE `user_name` LIKE '" + searchTerm + "%'");
    ...
    private void initComponents() {
        ...
        jPanel21Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel21Layout.createSequentialGroup()
                ...
                .addGroup(jPanel21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jScrollPane13, javax.swing.GroupLayout.DEFAULT_SIZE, 934, Short.MAX_VALUE)
                    .addGroup(jPanel21Layout.createSequentialGroup()
        ...
        jPanel22Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel22Layout.createSequentialGroup()
                ...
                .addGroup(jPanel22Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jScrollPane14, javax.swing.GroupLayout.DEFAULT_SIZE, 934, Short.MAX_VALUE)
                    .addGroup(jPanel22Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
        ...
        jPanel36Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel36Layout.createSequentialGroup()
                ...
                .addGroup(jPanel36Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jScrollPane21, javax.swing.GroupLayout.DEFAULT_SIZE, 944, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        managementpanelLayout.setHorizontalGroup(
            ...
            .addGroup(managementpanelLayout.createSequentialGroup()
                .addGap(0, 0, 0)
                .addComponent(jTabbedPane4, javax.swing.GroupLayout.DEFAULT_SIZE, 962, Short.MAX_VALUE)
                .addGap(0, 0, 0))
        );
        ...
        jPanel34Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel34Layout.createSequentialGroup()
                ...
                .addGroup(jPanel34Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jScrollPane17, javax.swing.GroupLayout.DEFAULT_SIZE, 950, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        jPanel35Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel35Layout.createSequentialGroup()
                .addGroup(jPanel35Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jScrollPane18, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 956, Short.MAX_VALUE)
                    .addGroup(jPanel35Layout.createSequentialGroup()
                        .addContainerGap()
        ...
        jPanel35Layout.setVerticalGroup(
            ...
            .addGroup(jPanel35Layout.createSequentialGroup()
                ...
                .addGroup(jPanel35Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel56))
                .addGap(20, 20, 20)
                .addComponent(jScrollPane18, javax.swing.GroupLayout.DEFAULT_SIZE, 348, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jScrollPane16, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 950, Short.MAX_VALUE)
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(jScrollPane31, javax.swing.GroupLayout.DEFAULT_SIZE, 946, Short.MAX_VALUE))
                .addGap(10, 10, 10))
        );
...
//            params.put("Parameter3", Basesalary);
    ...
    private void jTextField7KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField7KeyReleased
        String searchTerm = jTextField7.getText();
    ...
    private void jTextField20KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField20KeyReleased
        String searchTerm = jTextField20.getText();
        loadLogins(searchTerm);
    ...
    private void jTextField24KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField24KeyReleased
        String searchTerm = jTextField24.getText();
        loadEmployee(searchTerm);
